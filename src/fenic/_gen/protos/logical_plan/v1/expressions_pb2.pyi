...
class DateDiffExpr(_message.Message):
    ...
    EXPR1_FIELD_NUMBER: _ClassVar[int]
    EXPR2_FIELD_NUMBER: _ClassVar[int]
    expr1: LogicalExpr
    expr2: LogicalExpr
    def __init__(self, expr1: _Optional[_Union[LogicalExpr, _Mapping]] = ..., expr2: _Optional[_Union[LogicalExpr, _Mapping]] = ...) -> None: ...

class TimestampDiffExpr(_message.Message):
    __slots__ = ("expr1", "expr2", "unit")
    EXPR1_FIELD_NUMBER: _ClassVar[int]
    EXPR2_FIELD_NUMBER: _ClassVar[int]
    UNIT_FIELD_NUMBER: _ClassVar[int]
    expr1: LogicalExpr
    expr2: LogicalExpr
    unit: str
    def __init__(self, expr1: _Optional[_Union[LogicalExpr, _Mapping]] = ..., expr2: _Optional[_Union[LogicalExpr, _Mapping]] = ..., unit: _Optional[str] = ...) -> None: ...
